...
public class OrbmentConsoleCmd : AbstractConsoleCmd
{
    ...
    public override string Args => "<unlock|equip|totals|arts|cast|resetturn|addquartz>";
    ...
    public override CmdResult Process(Player? issuingPlayer, string[] args)
    {
        ...
        if (args.Length == 0)
        {
            return new CmdResult(
                false,
                "Usage: orbment unlock | orbment equip <quartzId> <slotIndex> | orbment totals | orbment arts | orbment cast <artId> | orbment addquartz <quartzId>"
            );
        }
        ...
        switch (args[0].ToLowerInvariant())
        {
            ...
            case "equip":
            {
                ...
                var quartz = QuartzDatabase.GetById(args[1]);
            ...
            case "arts":
            {
                ...
                return new CmdResult(true, string.Join(", ", arts.Select(a => a.Id)));
            }
            ...
            case "addquartz":
            {
                ...
                var ownedQuartz = QuartzDatabase.GetById(args[1]);
